...
```text
Assets/PulseForge/Demo/Scenes/PF\\\_DebugRhythmPrototype.unity
```
...
```text
Debug Audio Clip: PF\\\_Debug\\\_120BPM\\\_DefaultBeatMap.wav
Use Audio Clock When Clip Assigned: true
Debug Beat Map Asset: BM\\\_Debug\\\_120BPM\\\_Default
```
...
```text
Assets/PulseForge/Demo/Audio/PF\\\_Debug\\\_120BPM\\\_DefaultBeatMap.wav
```

Örnek beatmap asset:

```text
Assets/PulseForge/Demo/BeatMaps/BM\\\_Debug\\\_120BPM\\\_Default.asset
```
